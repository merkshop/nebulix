...
description: How to install and Merkshop.
...
| [![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/merkshop-io/Merkshop#BLOG_SLUG=blog&PORTFOLIO_SLUG=work&SHOP_SLUG=shop&MENU_SLUG=menu&WEBSITE_LANGUAGE=en&CURRENCY=USD&UNITS=metric&NODE_VERSION=18) | [![GitHub Repo stars](https://img.shields.io/github/stars/merkshop-io/Merkshop?logo=github)](https://github.com/merkshop-io/Merkshop) |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- |
...
Want to power my late night coding sessions? [Buy me a coffee](https://Merkshop.merkshop.io/shop/buy-me-a-coffee/)
