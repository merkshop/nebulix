...
tag:
  - Features
title: Contact Form
description: Merkshop contact form, get your leads trough MailGun, Postmark or Slack!
...
Merkshop contact form supports multiple topics, every topic can have their own destination email or slack channel. to open the contact dialog just create a link with `href="#contact"`
